                            ...
                            <ul className="flex items-center gap-6 text-sm">
                                ...
                                {!user &&
                                    <div className="sm:flex sm:gap-4">
                                        <a
                                            className="inline-block rounded border border-indigo-600 bg-indigo-600 px-4 py-2 font-medium text-white shadow-sm transition-colors hover:bg-indigo-700 cursor-pointer"
                                        ...
                                        <a
                                            className="inline-block rounded border border-gray-200 px-4 py-2 font-medium text-gray-700 shadow-sm transition-colors hover:bg-gray-50 hover:text-gray-900 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-white cursor-pointer"
