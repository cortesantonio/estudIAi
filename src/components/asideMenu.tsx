...
export const AsideMenu = () => {
    ...
    const [user] = useState(localStorage.getItem("user") ? JSON.parse(localStorage.getItem("user") as string) : null)

    useEffect(() => {
        setMsjAviso(!localStorage.getItem("msjVersion"))
    }, [])
                ...
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <Link to="/profile" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <img src="./public/marie.jpg" className="rounded-full size-8" alt="" />
                                <span className="flex-1 ms-3 whitespace-nowrap capitalize">{user.name}</span>
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <button onClick={logout} className="w-full flex items-center text-left p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <div id="dropdown-cta" className="p-4 mt-6 rounded-lg bg-blue-50 dark:bg-blue-900"
                        ...
                        <div className="flex items-center mb-3">
                            ...
                            <button
                                onClick={() => {
                                    localStorage.setItem("msjVersion", "false"); setMsjAviso(false)
                                }}
                                type="button"
