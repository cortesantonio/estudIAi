                ...
                <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
                    <div className="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                        ...
                        <p className="text-gray-500 dark:text-gray-300">
                            Organiza a tus compañeros, crea un grupo y sube documentos (Solo PDF) con el contenido de la materia.
                        </p>
                    </div>
                    <div className="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                        <span className="inline-block text-blue-500 dark:text-blue-400">
                        ...
                        <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Preguntas automáticas y flashcards</h1>
                        <p className="text-gray-500 dark:text-gray-300">
                            El sistema analiza el contenido y genera preguntas tipo quiz y flashcards para que practiques de forma personalizada.
                        </p>
                    </div>
                    <div className="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                        <span className="inline-block text-blue-500 dark:text-blue-400">
                        ...
                        <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white"> <span className="text-blue-500 opacity-70">Proximamente:</span> ranking y progreso</h1>
                        <p className="text-gray-500 dark:text-gray-300">
